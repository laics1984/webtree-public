  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
        class: ["wt-link", unref(nodeClasses)],
...
const LinkBlock = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-30057d25"]]);

export { LinkBlock as default };
//# sourceMappingURL=LinkBlock-BkX9Ft4U.mjs.map
