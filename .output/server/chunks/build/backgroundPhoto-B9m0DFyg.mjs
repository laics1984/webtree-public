globalThis.__timing__.logStart('Load chunks/build/backgroundPhoto-B9m0DFyg');const BACKGROUND_PHOTO_OPACITY_STYLE = "--builder-background-photo-opacity";
...
const getBackgroundPhotoSettings = (styles) => {
  const overlayColor = normalizeHexColor(
    typeof (styles == null ? void 0 : styles[BACKGROUND_PHOTO_OVERLAY_COLOR_STYLE]) === "string" ? styles == null ? void 0 : styles[BACKGROUND_PHOTO_OVERLAY_COLOR_STYLE] : void 0
  ) || DEFAULT_BACKGROUND_PHOTO_OVERLAY_COLOR;
  return {
    photoOpacity: parsePercentage(
      styles == null ? void 0 : styles[BACKGROUND_PHOTO_OPACITY_STYLE],
      DEFAULT_BACKGROUND_PHOTO_OPACITY
    ),
    overlayColor,
    overlayOpacity: parsePercentage(
      styles == null ? void 0 : styles[BACKGROUND_PHOTO_OVERLAY_OPACITY_STYLE],
      DEFAULT_BACKGROUND_PHOTO_OVERLAY_OPACITY
    )
  };
};
const hasBackgroundImage = (styles) => {
  const value = styles == null ? void 0 : styles.backgroundImage;
...
export { pickPhotoLayerStyles as a, getBackgroundPhotoSettings as g, hasBackgroundImage as h, pickBorderRadiusStyles as p, stripPhotoStyles as s, toRgbaString as t };;globalThis.__timing__.logEnd('Load chunks/build/backgroundPhoto-B9m0DFyg');
//# sourceMappingURL=backgroundPhoto-B9m0DFyg.mjs.map
