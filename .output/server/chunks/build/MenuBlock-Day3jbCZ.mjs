import { _ as _export_sfc, d as useRoute, e as __nuxt_component_0 } from './server.mjs';
...
import { r as runtimeMenusKey, h as runtimeHeaderSchemaKey, i as runtimeHeaderOverlayKey, a as getNodeClasses, b as getNodeStyles, c as getNodeDomId, e as getStringField, j as normalizeSchemaNodes, k as getArrayField, l as getNodeField, g as getNodeChildren, n as normalizeBlockType } from './PublicSitePage-C4ABRpXM.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const visibleItems = computed(() => items.value.filter((item) => (item == null ? void 0 : item.visible) !== false));
    ...
    const headerSupplemental = computed(() => {
      ...
      collectHeaderElements(normalizeSchemaNodes(runtimeHeaderSchema.value), (node) => {
        ...
        if (type === "menu") {
          ...
          utilityItems.push(...resolveMenuItemsForNode(node).filter((item) => (item == null ? void 0 : item.visible) !== false));
          return;
        }
        if (type !== "link") {
          return;
    ...
    function resolveMenuItemsForNode(node) {
      ...
      return Array.isArray(menu == null ? void 0 : menu.items) ? menu.items : [];
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isHeaderPrimaryMenu)) {
        ...
        }, _attrs))} data-v-8589f155><nav class="wt-menu wt-menu--desktop" data-v-8589f155><!--[-->`);
        ...
        _push(`<!--]--></nav><div class="wt-header-menu-toggle" data-v-8589f155><button type="button" class="wt-header-menu-toggle__button" style="${ssrRenderStyle({ color: unref(toggleTextColor), borderColor: unref(isOverlayHeader) ? "rgba(255,255,255,0.24)" : "rgba(148,163,184,0.35)" })}"${ssrRenderAttr("aria-expanded", unref(isMobileMenuOpen))}${ssrRenderAttr("aria-label", `Open ${unref(menuLabel)}`)} data-v-8589f155><span class="wt-header-menu-toggle__bars" aria-hidden="true" data-v-8589f155><span data-v-8589f155></span><span data-v-8589f155></span><span data-v-8589f155></span></span><span data-v-8589f155>Menu</span></button></div>`);
        ssrRenderTeleport(_push, (_push2) => {
          if (unref(isMobileMenuOpen)) {
            _push2(`<div class="${ssrRenderClass([{ "wt-mobile-menu-sheet--overlay": unref(isOverlayHeader) }, "wt-mobile-menu-sheet"])}" data-v-8589f155><div class="wt-mobile-menu-sheet__surface" data-v-8589f155><div class="wt-mobile-menu-sheet__top" data-v-8589f155><button type="button" class="wt-mobile-menu-sheet__close"${ssrRenderAttr("aria-label", `Close ${unref(menuLabel)}`)} data-v-8589f155><span class="wt-mobile-menu-sheet__close-mark" aria-hidden="true" data-v-8589f155>X</span><span data-v-8589f155>Close</span></button></div><div class="wt-mobile-menu-sheet__body" data-v-8589f155><nav class="wt-mobile-menu-list"${ssrRenderAttr("aria-label", unref(menuLabel))} data-v-8589f155><!--[-->`);
            ssrRenderList(unref(flattenedVisibleItems), (item) => {
              _push2(ssrRenderComponent(_component_NuxtLink, {
                key: `${item.id}:${item.depth}`,
                class: "wt-mobile-menu-link",
            ...
            if (unref(flattenedUtilityItems).length) {
              _push2(`<div class="wt-mobile-menu-section" data-v-8589f155><p class="wt-mobile-menu-section__title" data-v-8589f155>Utility</p><nav class="wt-mobile-menu-list" aria-label="Utility links" data-v-8589f155><!--[-->`);
              ssrRenderList(unref(flattenedUtilityItems), (item) => {
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  key: `utility:${item.id}:${item.depth}`,
                  class: "wt-mobile-menu-link wt-mobile-menu-link--secondary",
                  style: getMobileItemStyle(item.depth),
                  to: item.href,
                  target: item.target || void 0,
                  rel: item.rel || void 0,
            ...
            if (unref(headerSupplemental).actionLinks.length) {
              _push2(`<div class="wt-mobile-menu-actions" data-v-8589f155><!--[-->`);
              ssrRenderList(unref(headerSupplemental).actionLinks, (actionLink) => {
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  key: actionLink.id,
                  class: "wt-mobile-menu-action",
                  to: actionLink.href,
...
const MenuBlock = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8589f155"]]);

export { MenuBlock as default };
//# sourceMappingURL=MenuBlock-Day3jbCZ.mjs.map
