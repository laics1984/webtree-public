globalThis.__timing__.logStart('Load chunks/build/default-yxUPDbdc');import { defineComponent, withAsyncContext, computed, provide, mergeProps, unref, createVNode, resolveDynamicComponent, withCtx, openBlock, createBlock, Fragment, renderList, toValue, getCurrentInstance, onServerPrefetch, hasInjectionContext, inject, defineAsyncComponent, resolveComponent, ref, shallowRef, nextTick, toRef, useSSRContext, createElementBlock, cloneVNode, h } from 'vue';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderAttrs, ssrRenderClass, ssrRenderVNode, ssrRenderList } from 'vue/server-renderer';
import { d as useRoute, c as createError, u as useNuxtApp, b as asyncDataDefaults, a as useRuntimeConfig, t as tryUseNuxtApp, _ as _export_sfc } from './server.mjs';
import { C as removeResponseHeader, D as setResponseHeader, E as getResponseHeader } from '../nitro/nitro.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isDev = false;
    const registry = {
      header: defineAsyncComponent(() => import('./ContainerBlock-Dnbu2YP6.mjs')),
      body: defineAsyncComponent(() => import('./ContainerBlock-Dnbu2YP6.mjs')),
      footer: defineAsyncComponent(() => import('./ContainerBlock-Dnbu2YP6.mjs')),
      container: defineAsyncComponent(() => import('./ContainerBlock-Dnbu2YP6.mjs')),
      "2col": defineAsyncComponent(() => import('./ContainerBlock-Dnbu2YP6.mjs')),
      "3col": defineAsyncComponent(() => import('./ContainerBlock-Dnbu2YP6.mjs')),
      text: defineAsyncComponent(() => import('./TextBlock-zgyemoa2.mjs')),
      section: defineAsyncComponent(() => import('./SectionBlock-STHGqdEM.mjs')),
      image: defineAsyncComponent(() => import('./ImageBlock-x6d9d09i.mjs')),
      link: defineAsyncComponent(() => import('./LinkBlock-CTw-dBPP.mjs')),
      menu: defineAsyncComponent(() => import('./MenuBlock-DyaFmzDA.mjs')),
      hero: defineAsyncComponent(() => import('./HeroBlock-Bc2ljhR7.mjs')),
      contactform: defineAsyncComponent(() => import('./ContactFormBlock-xPlBKmRm.mjs'))
    };
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const runtimeMenus = computed(() => {
      var _a, _b, _c;
      return (_c = (_b = (_a = payload.value) == null ? void 0 : _a.site) == null ? void 0 : _b.menus) != null ? _c : [];
    });
...
export { ElementRenderer as E, _default as _, getNodeClasses as a, getNodeStyles as b, getNodeDomId as c, getNodeKey as d, getStringField as e, getBooleanField as f, getNodeChildren as g, runtimeHeaderSchemaKey as h, runtimeHeaderOverlayKey as i, normalizeSchemaNodes as j, getArrayField as k, getNodeField as l, getNodeContentRecord as m, normalizeBlockType as n, runtimeMenusKey as r };;globalThis.__timing__.logEnd('Load chunks/build/default-yxUPDbdc');
//# sourceMappingURL=default-yxUPDbdc.mjs.map
